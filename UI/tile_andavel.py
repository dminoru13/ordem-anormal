...
class tile:
    def __init__(self, cor_tile, posicao, altura: int | None = None, tipo: str | None = None):
        ...
        if tipo == "chao":
            ...
            pygame.draw.rect(self.surface, sombra_borda,
                             (0, tamanho_dos_tiles, tamanho_dos_tiles, tamanho_dos_tiles / 2))
            pygame.draw.rect(self.surface, sombra,
                             (1, tamanho_dos_tiles, tamanho_dos_tiles - 2, (tamanho_dos_tiles - 2) / 2))
